...
START_TEST(s21_add_1) {
  ...
  s21_decimal val_2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}};
  s21_decimal res = {{123123, 123123, 2345234, 2453245}};
  s21_decimal expected = {{0, 0, 0, 0}};
  int error = s21_add(val_1, val_2, &res);
...
START_TEST(s21_add_2) {
  s21_decimal val_1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0}};
  s21_decimal val_2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0}};
  s21_decimal res = {{123123, 123123, 2345234, 2453245}};
  s21_decimal expected = {{0, 0, 0, 0}};
  int error = s21_add(val_1, val_2, &res);
...
START_TEST(s21_add_3) {
  s21_decimal val_1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}};
  s21_decimal val_2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}};
  s21_decimal res = {{123123, 123123, 2345234, 2453245}};
  s21_decimal expected = {{0, 0, 0, 0}};
  int error = s21_add(val_1, val_2, &res);
...
START_TEST(s21_add_4) {
  s21_decimal val_1 = {{0x0340972E, 0, 0, 0}};
  s21_decimal val_2 = {{0x82E25AED, 0xF9E825AD, 0xB03EF094, 0x800E0000}};
  s21_decimal res = {{123123, 123123, 2345234, 2453245}};
  s21_decimal expected = {{0x712ADAED, 0x2E3CE1F8, 0xB03EEF6D, 0x800E0000}};
  int error = s21_add(val_1, val_2, &res);
  ck_assert_int_eq(error, 0);
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(res.bits[i], expected.bits[i]);
...
START_TEST(s21_div_1) {
  ...
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00000000000000000000000000000000;
  origin.bits[0] = 0b10101010111000000000000000000000;
  origin.bits[1] = 0b10111101000000100001001011111110;
  origin.bits[2] = 0b00100000011000011010101001001111;
...
START_TEST(s21_div_4) {
  ...
  int check_origin = 0;
  ck_assert_int_eq(check, check_origin);
  float res = -15032385536;
  float res_our_dec = 123;
  s21_from_decimal_to_float(result, &res_our_dec);
  ck_assert_float_eq(res_our_dec, res);
}
END_TEST
...
Suite *suite_s21_arithmetics() {
  ...
  suite = suite_create("s21_arithmetics");
  tcase = tcase_create("s21_arithmetics");

  tcase_add_test(tcase, s21_add_1);
  tcase_add_test(tcase, s21_add_2);
  tcase_add_test(tcase, s21_add_3);
  tcase_add_test(tcase, s21_add_4);

  tcase_add_test(tcase, s21_sub_1);
  tcase_add_test(tcase, s21_sub_2);
  tcase_add_test(tcase, s21_sub_3);
  tcase_add_test(tcase, s21_sub_4);
  tcase_add_test(tcase, s21_sub_5);
  tcase_add_test(tcase, s21_sub_6);
  tcase_add_test(tcase, s21_sub_7);
  tcase_add_test(tcase, s21_sub_8);
  tcase_add_test(tcase, s21_sub_9);
  tcase_add_test(tcase, s21_sub_10);
  tcase_add_test(tcase, s21_sub_11);
  tcase_add_test(tcase, s21_sub_15);
  tcase_add_test(tcase, s21_sub_16);
  tcase_add_test(tcase, s21_sub_17);
  tcase_add_test(tcase, s21_sub_22);
  tcase_add_test(tcase, s21_sub_23);
  tcase_add_test(tcase, s21_sub_24);
  tcase_add_test(tcase, s21_sub_26);
  tcase_add_test(tcase, s21_sub_28);
  tcase_add_test(tcase, s21_sub_30);
  tcase_add_test(tcase, s21_sub_35);
  tcase_add_test(tcase, s21_sub_36);
  tcase_add_test(tcase, s21_sub_39);
  tcase_add_test(tcase, s21_sub_48);
  tcase_add_test(tcase, s21_sub_49);
  tcase_add_test(tcase, s21_sub_50);
  tcase_add_test(tcase, s21_sub_51);
  tcase_add_test(tcase, s21_sub_52);
  tcase_add_test(tcase, s21_sub_53);

  tcase_add_test(tcase, s21_div_1);
  tcase_add_test(tcase, s21_div_2);
  tcase_add_test(tcase, s21_div_3);
  tcase_add_test(tcase, s21_div_4);
  tcase_add_test(tcase, s21_div_5);
  tcase_add_test(tcase, s21_div_7);
  tcase_add_test(tcase, s21_div_8);
  tcase_add_test(tcase, s21_div_10);
  tcase_add_test(tcase, s21_div_11);

  tcase_add_test(tcase, s21_mod_1);
  tcase_add_test(tcase, s21_mod_2);
  tcase_add_test(tcase, s21_mod_3);
  tcase_add_test(tcase, s21_mod_4);
  tcase_add_test(tcase, s21_mod_5);
  tcase_add_test(tcase, s21_mod_6);
  tcase_add_test(tcase, s21_mod_7);
  tcase_add_test(tcase, s21_mod_8);

  tcase_add_test(tcase, s21_mul_1);
  tcase_add_test(tcase, s21_mul_2);
  tcase_add_test(tcase, s21_mul_3);
  tcase_add_test(tcase, s21_mul_4);
  tcase_add_test(tcase, s21_mul_5);
  tcase_add_test(tcase, s21_mul_6);
  tcase_add_test(tcase, s21_mul_7);
