...
START_TEST(s21_truncate_1) {
  s21_decimal src = {{0x00000000, 0x4B100000, 0xAB5461CA, 0x001C0000}};
  s21_decimal dst = {0};
  s21_decimal result = {{5, 0, 0, 0}};
  int error = s21_truncate(src, &dst);
...
START_TEST(s21_truncate_2) {
  s21_decimal src = {{0x00000000, 0x4B100000, 0x0B5461CA, 0x001C0000}};
  s21_decimal dst = {0};
...
START_TEST(s21_truncate_3) {
  s21_decimal src = {{0xC5D7CAAE, 0x436AEFA9, 0x0A26AA02, 0x00100000}};
  s21_decimal dst = {0};
  s21_decimal result = {{0x25592735, 0x49, 0, 0}};
  int error = s21_truncate(src, &dst);
  ck_assert_int_eq(error, 0);
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(dst.bits[i], result.bits[i]);
...
Suite *suite_s21_others() {
  ...
  suite = suite_create("s21_others");
  tcase = tcase_create("s21_others");
  ...
  tcase_add_test(tcase, s21_round_10);
  tcase_add_test(tcase, s21_round_11);
  tcase_add_test(tcase, s21_round_12);
  tcase_add_test(tcase, s21_round_13);
  tcase_add_test(tcase, s21_round_14);
  tcase_add_test(tcase, s21_round_15);
  tcase_add_test(tcase, s21_round_16);
  tcase_add_test(tcase, s21_round_17);
  tcase_add_test(tcase, s21_round_18);
  tcase_add_test(tcase, s21_round_19);
  tcase_add_test(tcase, s21_round_20);
  tcase_add_test(tcase, s21_round_21);
  tcase_add_test(tcase, s21_round_22);
  tcase_add_test(tcase, s21_round_23);
  tcase_add_test(tcase, s21_round_24);

  tcase_add_test(tcase, s21_floor_1);
  tcase_add_test(tcase, s21_floor_2);
  tcase_add_test(tcase, s21_floor_3);
  tcase_add_test(tcase, s21_floor_4);
  tcase_add_test(tcase, s21_floor_5);
  tcase_add_test(tcase, s21_floor_6);
  tcase_add_test(tcase, s21_floor_7);
  tcase_add_test(tcase, s21_floor_8);
  tcase_add_test(tcase, s21_floor_9);
  tcase_add_test(tcase, s21_floor_10);
  tcase_add_test(tcase, s21_floor_11);
  tcase_add_test(tcase, s21_floor_12);
  tcase_add_test(tcase, s21_floor_13);
  tcase_add_test(tcase, s21_floor_14);
  tcase_add_test(tcase, s21_floor_15);
  tcase_add_test(tcase, s21_floor_16);
  tcase_add_test(tcase, s21_floor_17);
  tcase_add_test(tcase, s21_floor_18);
  tcase_add_test(tcase, s21_floor_19);
  tcase_add_test(tcase, s21_floor_20);
  tcase_add_test(tcase, s21_floor_21);
  tcase_add_test(tcase, s21_floor_22);
  tcase_add_test(tcase, s21_floor_23);
  tcase_add_test(tcase, s21_floor_24);
